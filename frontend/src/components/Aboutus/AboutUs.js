...
<Box className='ab' display='flex'>
  <Image width='40%' height='270px' src={main}></Image>
    <Text textAlign='left' marginLeft='10%' marginTop='3%'>
        <li>
      ...
      <div class="our_solution_category">
        ...
        <div class="solution_cards_box sol_card_top_3">
          <div class="solution_card">
            ...
            <div class="solu_title">
              <h3>Projects making them Industry Ready!</h3>
            </div>
            <div class="solu_description">
              <p>
          ...
          <div class="solution_card">
            ...
            <div class="solu_title">
              <h3>
Constant Update of Technologies</h3>
            </div>
            <div class="solu_description">
              <p>
